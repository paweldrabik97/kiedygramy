...
namespace kiedygramy.Migrations
{
    ...
    [Migration("20260402183231_AddGuestSupportAndSessionInviteLink")]
    partial class AddGuestSupportAndSessionInviteLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SessionGame", b =>
                {
            ...
            modelBuilder.Entity("kiedygramy.Domain.Notification", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsRead", "UpdatedAt");

                    b.HasIndex("UserId", "Key", "IsRead");
            ...
            modelBuilder.Entity("kiedygramy.Domain.SessionGameVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SessionId", "UserId", "GameKey")
                        .IsUnique();
            ...
            modelBuilder.Entity("kiedygramy.Domain.UserGame", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SessionGame", b =>
                {
                    b.HasOne("kiedygramy.Domain.Game", null)
                        .WithMany()
